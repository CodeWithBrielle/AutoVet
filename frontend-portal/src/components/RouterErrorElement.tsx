...
export default function RouterErrorElement() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-50 p-6 text-center dark:bg-dark-bg">
      ...
      <h1 className="text-3xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50">Portal Navigation Error</h1>
      <p className="mt-2 max-w-md text-zinc-500 dark:text-zinc-400">
        We encountered an error while loading this page. This might be due to a connection issue with the veterinary database.
      </p>
