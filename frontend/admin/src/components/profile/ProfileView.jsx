...
function ProfileView({ user, setUser }) {
    ...
    if (isLoading) {
        return <div className="p-10 text-center text-zinc-500 text-lg">Loading Profile Data...</div>;
    }
    ...
    if (fetchError) {
        return (
            <div className="mx-auto max-w-3xl space-y-6">
                <div>
                    <h2 className="text-4xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50">My Profile</h2>
                </div>
    ...
    return (
        <div className="mx-auto max-w-3xl space-y-6">
            <div>
                <h2 className="text-4xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50">My Profile</h2>
                <p className="mt-1 text-base text-zinc-500 dark:text-zinc-400">Manage your personal clinic information and avatar.</p>
            </div>

            <section className="card-shell p-6">
                <h3 className="mb-6 flex items-center gap-2 text-2xl font-bold text-zinc-900 dark:text-zinc-50">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-8 md:flex-row md:items-start">
                    ...
                    <div className="flex-1 space-y-4">
                        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                            <div>
                                <label className="mb-1 block text-sm font-semibold text-zinc-600 dark:text-zinc-300">Full Name *</label>
                                <input
                                    {...register("name")}
                                    className={clsx(
                                        "h-12 w-full rounded-xl border bg-zinc-50 px-4 text-base text-zinc-700 placeholder:text-zinc-400 focus:bg-white focus:outline-none dark:bg-dark-surface dark:text-zinc-200 dark:focus:bg-gray-800",
                                        errors.name ? "border-red-400 focus:border-red-500 dark:border-red-500/50" : "border-zinc-200 focus:border-emerald-300 dark:border-dark-border dark:focus:border-emerald-500"
                                    )}
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value={ROLES.CLINIC_ADMIN}>Administrator</option>
                            ...
                            <div className="lg:col-span-2">
                                <label className="mb-1 block text-sm font-semibold text-zinc-600 dark:text-zinc-300">Email Address *</label>
                                <input
                                    {...register("email")}
                                    type="email"
                                    className={clsx(
                                        "h-12 w-full rounded-xl border bg-zinc-50 px-4 text-base text-zinc-700 placeholder:text-zinc-400 focus:bg-white focus:outline-none dark:bg-dark-surface dark:text-zinc-200 dark:focus:bg-gray-800",
                                        errors.email ? "border-red-400 focus:border-red-500 dark:border-red-500/50" : "border-zinc-200 focus:border-emerald-300 dark:border-dark-border dark:focus:border-emerald-500"
                                    )}
                        ...
                        <div className="pt-4">
                            <button
                                ...
                                className="inline-flex h-11 items-center gap-2 rounded-xl bg-emerald-600 px-6 text-sm font-semibold text-white hover:bg-emerald-700 disabled:opacity-50"
                            >
