...
export default function ClientNotificationHistory() {
    ...
    const fetchHistory = async () => {
        try {
            ...
            const response = await api.get('/api/client-notifications', { params });
    ...
    const handleRetry = async (notification) => {
        try {
            setLoading(true);
            const response = await api.post(`/api/client-notifications/${notification.id}/retry`);
            const data = response.data;
            ...
            <div className="flex flex-wrap justify-between items-end mb-8 gap-6">
                ...
                <div className="flex gap-3">
                    ...
                    <select 
                        ...
                        className="rounded-xl border border-slate-200 bg-white p-2.5 text-xs font-black uppercase tracking-widest text-slate-700 shadow-sm focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 dark:bg-zinc-800 dark:border-zinc-700 dark:text-zinc-300 transition-all"
                    >
